...
.PHONY: all test clean deploy fund help install snapshot format anvil mint flipMood
...
deploy:
	@forge script script/DeployMoodNft.s.sol:DeployMoodNft ${NETWORK_ARGS} -vvvv
